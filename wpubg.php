        ...
        if (empty($error_msg)) {
            ...
            echo '
                ...
                <div style="text-align:center;">
                    <p style="padding:5px;"><h3 style="margin:0px;padding:0px;">'.$player.'</h3>Season '.substr($seasonID, -1).'</p>';
			if ($rankPointsTitle!=0) {
				echo '
                    <img src="'.plugin_dir_url(__FILE__).'gfx/'.strtolower(explode(" ",$rank)[0]).'.png" width="120">
                    <p style="padding:5px;"><strong>'.$rank.'</strong></p>';
			} else {
				echo '
					<img src="'.plugin_dir_url(__FILE__).'gfx/unranked.png" width="120">
                    <p style="padding:5px;"><strong>unranked</strong></p>';
			}
